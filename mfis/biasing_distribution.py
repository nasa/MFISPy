...
class BiasingDistribution(InputDistribution):
    ...
    Parameters
    ----------
    trained_surrogate : model that contained a .fit call
    ...
    def fit(self, n_samples, max_clusters=10,
        ...
        """
        Fits a Gaussian Mixture Model to a set of inputs from which the trained
        surrogate predicts will result in failures.
    ...
    def get_m_failed_inputs_from_surrogate_draws(self, n_samples,
        ...
        outputs using the surrogate, and determines the number of failures.
    ...
    def fit_from_failed_inputs(self, failed_inputs, max_clusters=10,
                               covariance_type=POSSIBLE_COVARIANCES):
        """
        Fits a Gaussian Mixture Model to a set of inputs that correspond to
    ...
    def evaluate_mixture_model_pdf(self, samples):
        """
        Evaluates the Gaussian Mixture Model's probability density function
    ...
    def save(self, filename):
        """
        Saves the object with all its attributes.
        
        Parameters
        ----------
        filename : filename
            A name for the pickle object.
